...
<template>
  <div class="relative max-w-[1980px] mx-auto flex gap-x-10 p-10 items-center justify-end py-28">
    <div class="w-full lg:w-auto">
      <h2 class="text-white text-subtitle lg:text-6xl font-bold">Thank you</h2>
